        ...
        <form ref={form}
         ...
         className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8 text-center'>
                <p className='text-4xl font-bold inline border-b-4 border-[#bababa] text-gray-300'>Contact</p>
            ...
            <button className='text-white border-2 hover:bg-[#bababa] hover:border-[#bababa] px-4 py-3 my-8 mx-auto flex items-center'>Let's Collaborate</button>
        </form>
    </div>
  )
}
